                    ...
                    <th>remove</th>
                        ...
                        data.map((ele,ind)=>{
                            ...
                            return(
                                ...
                                <td>{ele.contact}</td>
                                <td>{ele.course_id !== null ? ele.course_id.course : "--"}</td>
                                <td>{ele.joindate}</td>
                                <td>{ele.ref_id !== null ? ele.ref_id.reference_name : "--"}</td>
                                <td>{ele.ref_by}</td>
                                <td>{ele.inq_by !== null ? ele.inq_by.rolename : "--" }</td>
                                <td>{ele.inq_date}</td>
                                <td>{ele.status !== null ? ele.status.status : "--"}</td>
